...
//        professional4.getServicos().add(new ProfessionalService(3,"pintar unha", 30.0));
//        professional5.getServicos().add(new ProfessionalService(4,"corte de cabelo", 35.0d));
//        professional6.getServicos().add(new ProfessionalService(5,"corte de cabelo", 35.0d));
//        professional7.getServicos().add(new ProfessionalService(6,"costura", 20.0d));
//        professional8.getServicos().add(new ProfessionalService(7,"pintar unha", 30.0));
//
